...
import com.ronglexie.licenseclient.LicenseCheck;
...
public class LicenseManager implements LicenseCreator, LicenseVerifier {
	...
	protected synchronized void validate(LicenseContent paramLicenseContent)
		...
		Map<String,String> licenseCheckModel = (Map<String, String>) paramLicenseContent.getExtra();
		LicenseCheck.check(licenseCheckModel);
